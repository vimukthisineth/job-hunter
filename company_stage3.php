...
session_start();
  ...
  $email_verification=$_SESSION['company_email_verification'];
    ...
    <div class="row">
      ...
      <div class="col-md-5" style="height: 100vh;">
        ...
        <div class="row align-items-center">
          ...
          <?php if ($message=="The email address you entered is wrong or it has been already registered. Please check it again") {
            ?>
            <div class="col-10">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form role="form" method="post" action="index.html">
                    <div class="row">
              				<div class="col-xs-12 col-md-12"><input type="submit" value="Back to Homepage" class="btn btn-primary btn-block btn-lg" tabindex="7" style="width:100%; color:white; border-radius:25px 25px 25px 25px; font-family: 'Quicksand', sans-serif;"></div>
                  </form>
                    </div>
                </div>
              </div>
          ...
          <div class="col-10">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <form role="form" method="post" action="company_stage4.php">
                ...
                <form role="form" method="post" action="company_resend_email.php">
                  <div class="row">
