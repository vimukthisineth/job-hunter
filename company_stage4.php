...
require_once('db/dbconn.php');
  ...
  if ($activation_key!=$email_verification) {
    $_SESSION['message']="The code you entered is wrong !";
    header('Location: company_stage3.php');
  }
  else {
      $sql_account_activate = "UPDATE company_profile SET company_profile_active='1' WHERE company_profile_email='$email'";

    if ($conn->query($sql_account_activate) === TRUE) {
        ...
        <div class="row align-items-center">
          ...
          <div class="col-10">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title">Account activation complete</h5>
                <p class="card-text">Many thanks for your registration. We realy hope you'll make a bright future with us.</p>
                <hr>
                <form role="form" method="post" action="backend_company/index.php">
                  <div class="row">
            				<div class="col-xs-12 col-md-12"><input type="submit" value="Go to your account" class="btn btn-primary btn-block btn-lg" tabindex="7" style="width:100%; color:white; border-radius:25px 25px 25px 25px; font-family: 'Quicksand', sans-serif;"></div>
            			</div>
                </form>
              </div>
            </div>
